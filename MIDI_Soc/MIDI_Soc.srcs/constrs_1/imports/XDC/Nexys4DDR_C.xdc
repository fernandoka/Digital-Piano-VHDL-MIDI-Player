...
##IN SAMPLES
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports mclkDA]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports lrckDA]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports sclkDA]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports sdti]
##OUT SAMPLES
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports mclkAD]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports lrckAD]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports sclkAD]
#set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports sdto]
...
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports btRxD]
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { JC[4] }]; #IO_L19P_T3_35 Sch=jc[4]
#set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { JC[7] }]; #IO_L6P_T0_35 Sch=jc[7]
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports btRst_n]
...
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports io0]
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports io1]
#set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports io2]
#set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports io3]
...
set_false_path -from [get_pins RAM/DDR/rstn_reg/C] -to [get_pins RAM/DDR/Inst_DDR/u_ddr_mig/u_ddr2_infrastructure/rstdiv0_sync_r*/PRE];
